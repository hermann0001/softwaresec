...
int main (int argc, char *argv[]){
    ...
    printf("The size of char is %d byte, the size of short is %d bytes, the size of int is %d bytes.\n",
        (int)sizeof(char),(int)sizeof(short),(int)sizeof(int));
    printf("The size of char pointer is %d bytes, the size of short pointer is %d bytes, the size of int pointer is %d bytes.\n\n",
        (int)sizeof(char*),(int)sizeof(short*),(int)sizeof(int*));
    ...
    int* dynamic_array;
    dynamic_array = malloc(3*sizeof(int));
